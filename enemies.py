...
class Mosquito(object):
	...
	def __init__(self,world):
		...
		self.flying_sound=openal.oalOpen("fx/mosquito.ogg")
		self.flying_sound.set_looping(True)
		self.flying_sound.set_gain(6.0)
		self.updatePosition()
	...
	def updatePosition(self):
		...
		self.flying_sound.set_position((self.x,0,self.z))
